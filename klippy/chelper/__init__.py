...
SOURCE_FILES = [
    ...
    'kin_polar.c', 'kin_rotary_delta.c', 'kin_winch.c', 'kin_hybrid_corexz.c',
...
defs_kin_hybrid_corexz = """
   struct stepper_kinematics *hybrid_corexz_stepper_alloc(char status);
"""
...
defs_all = [
    ...
    defs_kin_winch, defs_kin_hybrid_corexz, defs_kin_extruder, defs_kin_shaper,
]
